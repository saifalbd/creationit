    ...
    <main>
        <div class="container-fluid">
            <div class="card mt-4">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-9 my-auto">
                            ...
                            </svg><!-- <i class="fas fa-layer-group"></i> --> Add Success Student <svg
                ...
                <form method="post" action="{{route("successfull.store")}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="inputEmail4">Sudent Name <span>*</span> </label>
                                <input type="text" class="form-control" name="name" placeholder="Ex: John Smith">
                            @error('name')
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="course" placeholder="Ex: Web Design">
                           @error('course')
                                <div class="alert alert-danger mt-2">{{$message}}</div>
                            @enderror
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="designation" placeholder="Ex: Web Developer at Cretion It ">
                            @error('designation')
                                <div class="alert alert-danger mt-2">{{$message}}</div>
                            @enderror
                            </div>

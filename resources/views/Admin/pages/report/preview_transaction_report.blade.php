<x-report-layout title="DATE WISE TRANSACTION REPORT">
    @slot('date')
    ...
    <thead>
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: right;" >{{$voucher->type=='receipt'?$voucher->amount:0}}</td>
                    <td style="text-align: right;">{{$voucher->type=='payment'?$voucher->amount:0}}</td>
                 </tr>
                @endforeach

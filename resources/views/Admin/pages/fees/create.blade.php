...
<div class="card mt-4">
   ...
   <div class="row">
      ...
      <div class="col-md-3 text-right">
         ...
         <a href="{{route('fees.index')}}" class="btn btn-outline-primary"> <i class="fas fa-folder-open"></i> Received Record</a>
      </div>
   </div>
</div>
<div class="card mb-4">
   <div class="mt-3 card-body">
 <form name="frmUser" method="post" action="{{route('fees.store')}}" enctype="multipart/form-data" >
	@csrf
         <div class="form-row">
		     ...
		     <div class="form-group col-md-8" style="display: ;">
			   ...
			   <select name="admission_id" class="form-control js-select2" required>
                <option >---</option>
			...
			<div class="form-group col-md-2">
               <label for="inputEmail4"> Date</label>
                <input type="date" class="form-control" name="date" value="2023-06-09">
				@error('date')
				<div class="alert alert-danger mt-2">
					<span>{{$message}}</span>
				</div>

      ...
      <div class="row">
          <div class="form-group col-md-4">
			...
			<div class="form-group col-md-4">
               ...
               <input type="number" class="form-control" required  name="mobile_guardian">
               @error('mobile_guardian')
                  <div class="alert alert-danger mt-2">
                     <span>{{$message}}</span>
                  </div>
               @enderror
...
<div class="card mb-2">
   ...
   <div class="card-body">
	  ...
	  <div class="form-group col-md-4">
          ...
          <select name="type" id="type" class="js-select2" required >
            <option >---</option>
         ...
         <div class="form-group col-md-2">
            ...
            <input type="number" required class="form-control" name="reg">
            @error('reg')
               <div class="alert alert-danger mt-2">
                  <span>{{$message}}</span>
               </div>

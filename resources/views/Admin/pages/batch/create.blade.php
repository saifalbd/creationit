<x-admin-layout>
    ...
    <main>
        <div class="container-fluid">
            <form name="frmUser" method="post" action="{{ route('batch.store') }}" enctype="multipart/form-data">
                <div class="card mt-4">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    required="" name="title" placeholder="Ex: 2nd Batch (Microsoft Office)">
                                @error('title')
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control @error('saturday') is-invalid @enderror"
                                    name="saturday" placeholder="Ex: 10:30-11:30">
                                @error('saturday')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>

...
var menuIcon = document.getElementById('sidebarToggle');
var iconActive = document.querySelector('.sidebar-btn');
...
function showList(start, end) {
  ...
  Array.prototype.forEach.call(rows, function (row, i) {
    var tds = row.getElementsByClassName('table-col');
...
var crudeError = function crudeError(property) {
  var queryString = window.location.search;
  var parameters = new URLSearchParams(queryString);
  var success = parameters.get(property);
  if (success) {
    swal({
      position: 'center',
      icon: 'error',
    ...
    var newUrl = "".concat(window.location.origin).concat(window.location.pathname, "?").concat(parameters.toString());
    window.history.replaceState(null, null, newUrl);
  }
};
var crudeAlert = function crudeAlert(property) {
  var queryString = window.location.search;
  var parameters = new URLSearchParams(queryString);
  var success = parameters.get(property);
  if (success) {
